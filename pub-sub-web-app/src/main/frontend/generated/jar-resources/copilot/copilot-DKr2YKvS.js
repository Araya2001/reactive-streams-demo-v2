...
function Do(e, t) {
    ...
    function a(l, s) {
        var c, d, u = Me(l)[g],
            f = new ve(s, (c = (d = r.options_) == null ? void 0 : d.enhancer) != null ? c : ge, process.env.NODE_ENV !== "production" ? u.name_ + "." + i.toString() : "ObservableObject." + i.toString(), !1);
...
var wr = "action", ua = "action.bound", Zn = "autoAction", da = "autoAction.bound", Yn = "<unnamed action>", hr = /* @__PURE__ */ ut(wr),
    ha = /* @__PURE__ */ ut(ua, {
        bound: !0
    }), vr = /* @__PURE__ */ ut(Zn, {
        autoAction: !0
...
function ei(e, t) {
    ...
    var l = (r = (n = t) == null ? void 0 : n.name) != null ? r : process.env.NODE_ENV !== "production" ? e.name || "Autorun@" + M() : "Autorun",
...
function ri(e, t, r) {
    ...
    var l = (n = r.name) != null ? n : process.env.NODE_ENV !== "production" ? "Reaction@" + M() : "Reaction",
        s = de(l, r.onError ? pa(r.onError, t) : t), c = !r.scheduler && !r.delay, d = ti(r), u = !0, f = !1, p,
        y = r.compareStructural ? Ve.structural : r.equals || Ve.default, m = new Ze(l, function () {
            u || c ? S() : f || (f = !0, d(S));
...
var Qt = /* @__PURE__ */ Cn("flow"), Aa = /* @__PURE__ */ Cn("flow.bound", {
    ...
    var n = t, i = n.name || "<unnamed flow>", o = function () {
        var l = this, s = arguments, c = ++Oa, d = de(i + " - runid: " + c + " - init", n).apply(l, s), u, f = void 0,
...
var fi = /* @__PURE__ */ function () {
    ...
    }(), Ie = /* @__PURE__ */ we("ObservableSet", fi), Fr = /* @__PURE__ */ Object.create(null), Wr = "remove",
...
Extending builtins is not supported.`), e;
    ...
    var n = (r = t?.name) != null ? r : process.env.NODE_ENV !== "production" ? (D(e) ? "ObservableObject" : e.constructor.name) + "@" + M() : "ObservableObject",
        i = new fr(e, /* @__PURE__ */ new Map(), String(n), Ko(t));
    return Bt(e, g, i), e;
}
...
const rt = "copilot-", Ka = "24.4.3", fl = "attention-required", pl = "https://plugins.jetbrains.com/plugin/23758-vaadin",
    gl = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode",
    _l = (e, t, r) => t >= e.left && t <= e.right && r >= e.top && r <= e.bottom, qa = (e) => {
        const t = [];
        let r = Fa(e);
        for (; r;)
 ...
 */
const St = globalThis,
    Cr = St.ShadowRoot && (St.ShadyCSS === void 0 || St.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype,
    Tr = Symbol(), tn = /* @__PURE__ */ new WeakMap();
let Si = class {
    constructor(t, r, n) {
...
const {
        ...
        getOwnPropertyNames: is,
        getOwnPropertySymbols: os,
        getPrototypeOf: as
    } = Object, Xt = globalThis, nn = Xt.trustedTypes, ss = nn ? nn.emptyScript : "", ls = Xt.reactiveElementPolyfillSupport, Ge = (e, t) => e,
    gr = {
        toAttribute(e, t) {
            switch (t) {
                case Boolean:
...
let Pe = class extends HTMLElement {
    ...
    static getPropertyDescriptor(t, r, n) {
        const {get: i, set: o} = ns(this.prototype, t) ?? {
            get() {
                return this[r];
            }, set(a) {
                this[r] = a;
    ...
    _$AK(t, r) {
        ...
        if (i !== void 0 && this._$Em !== i) {
            const o = n.getPropertyOptions(i),
                a = typeof o.converter == "function" ? {fromAttribute: o.converter} : o.converter?.fromAttribute !== void 0 ? o.converter : gr;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Vr = globalThis, Lt = Vr.trustedTypes, sn = Lt ? Lt.createPolicy("lit-html", {createHTML: (e) => e}) : void 0, Rr = "$lit$",
    Z = `lit$${(Math.random() + "").slice(9)}$`, jr = "?" + Z, ds = `<${jr}>`, Oe = document, it = () => Oe.createComment(""),
    ot = (e) => e === null || typeof e != "object" && typeof e != "function", xi = Array.isArray,
    $i = (e) => xi(e) || typeof e?.[Symbol.iterator] == "function", rr = `[ 	
\f\r]`, Ke = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ln = /-->/g, cn = />/g,
    se = RegExp(`>|${rr}(?:([^\\s"'>=/]+)(${rr}*=${rr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), un = /'/g, dn = /"/g, Di = /^(?:script|style|textarea|title)$/i,
    Pi = (e) => (t, ...r) => ({_$litType$: e, strings: t, values: r}), _r = Pi(1), xl = Pi(2), Ae = Symbol.for("lit-noChange"),
    E = Symbol.for("lit-nothing"), hn = /* @__PURE__ */ new WeakMap(), he = Oe.createTreeWalker(Oe, 129);
...
class Ue {
    ...
    $(t) {
        const {values: r, _$litType$: n} = t,
            i = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = at.createElement(Ci(n.h, n.h[0]), this.options)), n);
        if (this._$AH?._$AD === i)
            this._$AH.p(r);
        else {
...
class ki extends pt {
    ...
    _$AI(t, r = this) {
        if ((t = Ee(this, t, r, 0) ?? E) === Ae)
            return;
        const n = this._$AH, i = t === E && n !== E || t.capture !== n.capture || t.once !== n.once || t.passive !== n.passive,
            o = t !== E && (n === E || i);
...
const Bi = () => {
    ...
    }, Ss = async () => Es(`${rt}get-user-info`, {}, (e) => (delete e.data.reqId, e.data)), Ns = async () => wi(() => _.userInfo),
    Pl = async () => (await Ns()).vaadiner;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ks = {ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6},
    Ls = (e) => (...t) => ({_$litDirective$: e, values: t});
let Is = class {
    constructor(t) {
    }
