import {b as u, l as h, P as v, s as f, t as b, x as d} from "./copilot-DKr2YKvS.js";
import {r as p} from "./state-eevs1asN.js";
import {e as g, m} from "./overlay-monkeypatch-BpxWVdY5.js";
...
const c = "https://github.com/vaadin/copilot/issues/new", A = "?template=feature_request.md&title=%5BFEATURE%5D",
    P = "A short, concise description of the bug and why you consider it a bug. Any details like exceptions and logs can be helpful as well.",
    T = "Please provide as many details as possible, this will help us deliver a fix as soon as possible.%0AThank you!%0A%0A%23%23%23 Description of the Bug%0A%0A{description}%0A%0A%23%23%23 Expected Behavior%0A%0AA description of what you would expect to happen. (Sometimes it is clear what the expected outcome is if something does not work, other times, it is not super clear.)%0A%0A%23%23%23 Minimal Reproducible Example%0A%0AWe would appreciate the minimum code with which we can reproduce the issue.%0A%0A%23%23%23 Versions%0A{versionsInfo}";
let i = class extends y {
    ...
    openGithub(e, a) {
        ...
        const l = e.replace(/\n/g, "%0A"), n = `${a.items.find((r) => r.value === this.type)?.ghTitle}`,
            t = a.description !== "" ? a.description : P, s = T.replace("{description}", t).replace("{versionsInfo}", l);
